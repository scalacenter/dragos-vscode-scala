...
export async function activate(context: ExtensionContext) {
  ...
  let coursierArgs = ['launch', '-r', 'https://dl.bintray.com/dhpcs/maven', '-r', 'sonatype:releases', '-J', toolsJar, 'com.github.dragos:ensime-lsp_2.11:0.1.4-profiledb-SNAPSHOT', '-M', 'org.github.dragos.vscode.Main'];
